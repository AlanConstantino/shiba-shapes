import { context, gravity, shapes } from '../script.js';
...
export default class Triangle {
    ...
    constructor(sideLength, lineWidth, color, shiba, src) {
        ...
        this.y = innerHeight;
        this.vx = 0; // isn't really needed as of now
        this.vy = -20;
    ...
    update() {
        ...
        /* 
            The collision detection for the triangles is just
            an approximation. It isn't accurate.
        */
